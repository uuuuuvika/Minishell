...
//     int i;
//     char **tmp;
//     tmp = malloc(sizeof(char*) * (count_env(data->envs) + 1));
//     if(tmp == NULL)
//         return(-1);
//     i = 0;
//     while(data->envs[i] != NULL)
//     {
//         if(ft_strncmp(data->envs[i], cmd->args[1], varname_len(data->envs[i])) == 0)
//         {
//             tmp[i] = cmd->args[1];
//             i++;
//         }
...
void ft_export(t_data *data, t_cmd *cmd)
{
    ...
    i = 0;
    j = 1;
    check_NULL(cmd->args[1]); //neeed to check args format as well & handle no arguments
